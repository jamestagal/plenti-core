...
export const isMediaPath = media => typeof media === 'string' && reMediaPath.test(media.toLowerCase());
export const isImagePath = media => typeof media === 'string' && reImagePath.test(media.toLowerCase());
export const isDocPath = media => typeof media === 'string' && reDocPath.test(media.toLowerCase());